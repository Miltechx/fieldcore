    ...
    <>
      ...
      <aside className="hidden md:flex flex-col w-60 flex-shrink-0 bg-[#111827] border-r border-[#1F2937] h-screen fixed left-0 top-0 z-30">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="px-4 mt-6 mb-2 text-[10px] uppercase tracking-widest text-[#6B7280]">Communication</div>
          {[
            { label: 'Comms', href: '/comms', icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg> },
            { label: 'Invoice', href: '/invoice', icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg> },
          ].map(item => (
            <Link key={item.href} href={item.href} className={navLinkClass(item.href)}>
              {item.icon}
              {item.label}
